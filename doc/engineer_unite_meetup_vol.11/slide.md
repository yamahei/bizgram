...
| # | AI                                                                      | エンジン         | 評価 | 所感                                                                     |
|:-:|:------------------------------------------------------------------------|:-----------------|:-----|:-------------------------------------------------------------------------|
| 1 | Gemini CLI ![height:30px](./logo_gemini-cli-icon_full-color@4x.png)     | Gemini系         | △   | 作れなくはないが、自分で作ったほうが早いレベル                           |
| 2 | Github Copilot ![height:30px](./logo_github-copilot.webp)               | Claude Haiku 4.5 | △   | ↑より多少マシだが、ダメ出しに弱い（パニックになって余計な変更しまくる） |
