...
`Graphviz`、`PlantUML`、`Mermaid.js`辺りを目指した
...
自動配置アルゴリズムを含む見栄えの調整が一番時間がかかった。

---

# 自動配置アルゴリズム（主体・矢印・コメント）
...
頭の中のイメージを外部仕様に書き出して実装。
結果を確認して仕様を見直し、を繰り返した。
...
### 所感
- **期待するゴール**に妥協しない方が良さそう。
- **AIが出してきた結果**から、AIの理解度を読み解き、適切にタスク分割して指示するのが良い。
</div>
</div>
